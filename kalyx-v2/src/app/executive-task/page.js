...
import { 
  ...
  Trash2, Edit, Calendar, User, Eye, EyeOff, Save, Download
} from "lucide-react";
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/45 backdrop-blur-sm p-4">
          <div className="bg-surface-container-lowest rounded-2xl shadow-2xl max-w-xl w-full max-h-[85vh] overflow-y-auto flex flex-col">
            ...
            <div className="p-6 border-t border-outline-variant bg-surface-container flex gap-3">
              <button onClick={() => openEditPlanModal(selectedPlan)} className="flex-1 bg-white hover:bg-surface-container-high py-2.5 rounded-xl font-bold transition-all text-xs border border-outline flex items-center justify-center gap-1.5"><Edit className="w-4 h-4" /> Edit Plan</button>
